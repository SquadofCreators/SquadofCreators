  ...
  return (
    <div className="flex flex-col items-center justify-center p-6 h-dvh bg-gradient-to-r from-indigo-500 to-blue-500 text-white">
        <div className="text-center flex flex-col items-center justify-center gap-4">
            <h1 className="text-4xl md:text-6xl font-bold mb-4">Our Blog is Coming Soon!</h1>
            <p className="text-lg md:text-xl mb-6">
            Stay tuned for insightful articles, tips, and stories from our team. Subscribe to be the first to read our updates!
            </p>
